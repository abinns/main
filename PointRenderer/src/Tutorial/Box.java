...
public class Box extends GameObject
{
	...
	private static float[]	vertices	= new float[]
											{ -Box.width, -Box.height, 0.2f, -Box.width, Box.height, 0.2f, Box.width, Box.height, 0.2f, Box.width, -Box.height, 0.2f };
	...
	public Box()
	{
		super(Box.vertices, Box.indices, Box.texCoords, Box.texPath);
	}
