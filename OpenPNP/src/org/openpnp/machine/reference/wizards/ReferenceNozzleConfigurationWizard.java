...
public class ReferenceNozzleConfigurationWizard extends AbstractConfigurationWizard
{
	...
	public ReferenceNozzleConfigurationWizard(ReferenceNozzle nozzle)
	{
		...
		this.panelChanger.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Settings", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		this.chckbxChangerEnabled = new JCheckBox("Changer Enabled?");
		this.panelChanger.add(this.chckbxChangerEnabled, "2, 2");

		this.chckbxLimitRotationTo = new JCheckBox("Limit Rotation to 180º");
		this.panelChanger.add(this.chckbxLimitRotationTo, "2, 4");
	...
	public void createBindings()
	{
		...
		this.bind(UpdateStrategy.READ_WRITE, this.nozzle, "headOffsets", headOffsets, "location");
		...
		this.addWrappedBinding(this.nozzle, "changerEnabled", this.chckbxChangerEnabled, "selected");
		this.addWrappedBinding(this.nozzle, "limitRotation", this.chckbxLimitRotationTo, "selected");
		this.addWrappedBinding(this.nozzle, "safeZ", this.textFieldSafeZ, "text", lengthConverter);
