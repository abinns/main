...
public class ReferenceJobProcessorConfigurationWizard extends AbstractConfigurationWizard
{
	...
	public ReferenceJobProcessorConfigurationWizard(ReferenceJobProcessor jobProcessor)
	{
		...
		this.panelGeneral.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Settings", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		this.chckbxDemoMode = new JCheckBox("Demo Mode?");
		this.panelGeneral.add(this.chckbxDemoMode, "2, 2");
	}

	@Override
	public void createBindings()
	{
		this.addWrappedBinding(this.jobProcessor, "demoMode", this.chckbxDemoMode, "selected");
	}
}
