...
public class LtiCivilCameraConfigurationWizard extends ReferenceCameraConfigurationWizard
{
	...
	public LtiCivilCameraConfigurationWizard(LtiCivilCamera camera)
	{
		...
		this.chckbxForceGrayscale = new JCheckBox("Force Grayscale?");
		this.panelGeneral.add(this.chckbxForceGrayscale, "2, 4, 3, 1");
	}
	...
	public void createBindings()
	{
		...
		this.addWrappedBinding(this.camera, "forceGrayscale", this.chckbxForceGrayscale, "selected");
