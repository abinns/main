...
/**
 * Allows an interested listener to receive events as the JobProcessor does it's
 * work. Methods in this interface are for passive observers.
 */
public interface JobProcessorListener
{
	...
	/**
	 * Indicates that the state of the Job has changed. This is generally in
	 * response to one of the Job control methods such as start(), pause(),
	 * resume(), or stop() being called.
	 * 
	 * @param state
	 */
	public void jobStateChanged(JobState state);
	...
	/**
	 * Fired when the JobProcessor has begun operations that include the given
	 * Placement.
	 * 
	 * @param board
	 * @param placement
