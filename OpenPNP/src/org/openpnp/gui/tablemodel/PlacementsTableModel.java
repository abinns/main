...
public class PlacementsTableModel extends AbstractTableModel
{
	...
	{ "Id", "Part", "Side", "X", "Y", "ø", "Type", "Status" };

	private Class[] columnTypes = new Class[]
	{ String.class, Part.class, Side.class, LengthCellValue.class, LengthCellValue.class, String.class, Type.class, Status.class };
	...
	{
		return this.board == null ? 0 : this.board.getPlacements().size();
	}

	@Override
	public Object getValueAt(int row, int col)
	{
		Placement placement = this.board.getPlacements().get(row);
		...
		switch (col)
		{
			...
			case 7:
				return this.getPlacementStatus(placement);
			default:
				return null;
		}
	}
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex)
	{
		try
		{
			Placement placement = this.board.getPlacements().get(rowIndex);
			if (columnIndex == 1)
			...
			else if (columnIndex == 3)
			{
				...
				location = Length.setLocationField(this.configuration, location, length, Length.Field.X, true);
			...
			} else if (columnIndex == 4)
			{
				...
				Length length = value.getLength();
				Location location = placement.getLocation();
				location = Length.setLocationField(this.configuration, location, length, Length.Field.Y, true);
				placement.setLocation(location);
