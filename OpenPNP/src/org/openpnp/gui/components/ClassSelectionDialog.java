...
public class ClassSelectionDialog<T> extends JDialog
{
	...
	private final Action selectAction = new AbstractAction("Accept")
	{
		...
		{
			ClassSelectionDialog.this.selectedClass = ((ClassListItem<T>) ClassSelectionDialog.this.list.getSelectedValue()).getTheClass();
	...
	public ClassSelectionDialog(Frame parent, String title, String description, List<Class<? extends T>> classes)
	{
		...
		JButton btnSelect = new JButton(this.selectAction);
		...
		this.list.addMouseListener(new MouseAdapter()
		{
			...
			public void mouseClicked(MouseEvent e)
			{
				if (e.getClickCount() == 2)
					ClassSelectionDialog.this.selectAction.actionPerformed(null);
			}
		});
		this.list.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		this.list.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		...
		this.list.addListSelectionListener(new ListSelectionListener()
		{
			...
			public void valueChanged(ListSelectionEvent e)
			{
				if (e.getValueIsAdjusting())
					return;
				ClassSelectionDialog.this.selectAction.setEnabled(ClassSelectionDialog.this.list.getSelectedValue() != null);
			}
		});
