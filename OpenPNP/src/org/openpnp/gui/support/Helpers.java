...
public class Helpers
{
	...
	{
		Helpers.copyLocationIntoTextFields(l, x, y, z, null);
	}
	...
	/**
	 * Create a unique name consisting of the prefix and an integer. The name is
	 * guaranteed to be unique within the properties of the given Collection
	...
	/**
	 * Select the last row in a table. Handy for selecting a row that was just
	 * added.
	 * 
	 * @param table
	 */
