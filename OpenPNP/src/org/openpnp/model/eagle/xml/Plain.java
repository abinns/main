...
public class Plain
{
	...
	{ @XmlElement(name = "polygon", type = Polygon.class), @XmlElement(name = "wire", type = Wire.class), @XmlElement(name = "text", type = Text.class),
			...
			@XmlElement(name = "frame", type = Frame.class), @XmlElement(name = "hole", type = Hole.class) })
	 ...
	 * {@link Rectangle } {@link Frame } {@link Hole }
	 */
	public List<Object> getPolygonOrWireOrTextOrDimensionOrCircleOrRectangleOrFrameOrHole()
	{
		if (this.polygonOrWireOrTextOrDimensionOrCircleOrRectangleOrFrameOrHole == null)
			this.polygonOrWireOrTextOrDimensionOrCircleOrRectangleOrFrameOrHole = new ArrayList<>();
