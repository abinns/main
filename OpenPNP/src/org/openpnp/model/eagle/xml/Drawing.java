...
{ "settings", "grid", "layers", "libraryOrSchematicOrBoard" })
...
public class Drawing
{
	...
	@XmlElements(
	{ @XmlElement(name = "library", required = true, type = Library.class), @XmlElement(name = "schematic", required = true, type = Schematic.class),
	 ...
	 * <CODE>set</CODE> method for the libraryOrSchematicOrBoard property.
	 * <p>
	 ...
	 * {@link Schematic } {@link Board }
	 */
	public List<Object> getLibraryOrSchematicOrBoard()
	{
		if (this.libraryOrSchematicOrBoard == null)
			this.libraryOrSchematicOrBoard = new ArrayList<>();
