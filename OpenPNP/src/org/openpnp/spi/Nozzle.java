...
public interface Nozzle extends Identifiable, Named, HeadMountable, WizardConfigurable, PropertySheetHolder
{
	...
	/**
	 * Changer interface: Command the Nozzle to load the given NozzleTip as it's
	 * current NozzleTip. If this returns without Exception then subsequently
	 * calling getNozzleTip() should return the same NozzleTip as was passed to
	 * this call. If the specified NozzleTip is already loaded this method
	 * should do nothing.
	 * 
	 * @param nozzleTip
	 * @throws Exception
	...
	/**
	 * Changer interface: Unload the current NozzleTip from the Nozzle, leaving
	 * it empty. After this call getNozzleTip() should return null.
	 * 
	 * @throws Exception
	 */
