 ...
 * expected that all components attached to the Head also move in the same axes.
 */
public interface Head extends Identifiable, Named, WizardConfigurable, PropertySheetHolder
{
	...
	/**
	 * Directs the Head to move to it's home position and to move any attached
	 * devices to their home positions.
	 */
