...
public interface Camera extends Identifiable, Named, HeadMountable, WizardConfigurable, PropertySheetHolder, Closeable
{
	...
	/**
	 * Immediately captures an image from the camera and returns it in it's
	 * native format.
	 * 
	 * @return
	 */
	...
	/**
	 * Get the height of images in pixels that will be returned from this
	 * Camera.
	 * 
	 * @return
	 */
	...
	/**
	 * Get the time in milliseconds that the Camera should be allowed to settle
	 * before images are captured for vision operations.
	 * 
	 * @return
	 */
	...
	/**
	 * The number of X and Y units per pixel this camera shows when in perfect
	 * focus. Location isn't a great datatype for this, but it gets the job
	 * done.
	 * 
	 * @return
	 */
	...
	/**
	 * Registers a listener to receive continuous images from the camera at a
	 * rate less than or equal to maximumFps images per second.
	 * 
	 * @param listener
	 * @param maximumFps
	 */
	...
	/**
	 * Requests that the continuous capture be stopped for the previously
	 * registered listener. If the Camera has other listeners they should still
	 * receive updates.
	 * 
	 * @param listener
	 */
