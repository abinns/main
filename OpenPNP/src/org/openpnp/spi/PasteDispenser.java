...
public interface PasteDispenser extends Identifiable, Named, HeadMountable, WizardConfigurable, PropertySheetHolder
{
	 ...
	 * endLocation taking dispenseTimeMilliseconds milliseconds. If the
	 * endLocation is null the dispenser should dispense at the startLocation.
	 * If both locations are null the dispenser will dispense at the current
	 * location.
	 * 
	 * @param startLocation
	 * @param endLocation
