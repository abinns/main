...
public class UnsafeMemory
{
	...
	public void putFloatArray(final float[] values)
	{
		...
		unsafe.copyMemory(values, floatArrayOffset, buffer, byteArrayOffset + pos, bytesToCopy);
		pos += bytesToCopy;
	}
	...
	public float[] getFloatArray()
	{
		...
		long bytesToCopy = values.length << 2;
		unsafe.copyMemory(buffer, floatArrayOffset + pos, values, doubleArrayOffset, bytesToCopy);
		pos += bytesToCopy;
		return values;
	}
}